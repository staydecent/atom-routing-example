...
},{"error/typed":8,"raf":9}],5:[function(require,module,exports){
...
},{"camelize":5,"string-template":6,"xtend/mutable":7}],9:[function(require,module,exports){
...
},{"../vnode/handle-thunk":33,"../vnode/is-thunk":34,"../vnode/is-vnode":36,"../vnode/is-vtext":37,"../vnode/is-widget":38,"../vnode/vpatch":41,"./diff-props":43,"x-is-array":21}],45:[function(require,module,exports){
'use strict';
...
function render(_ref) {
  ...
  var page = undefined;
  if (url === '/') {
    page = (0, _virtualDomH2['default'])('h1', {}, ['Home']);
  } else if (url === '/about') {
    page = (0, _virtualDomH2['default'])('h1', {}, ['About']);
  } else {
    page = (0, _virtualDomH2['default'])('h1', {}, ['404']);
  }

  return (0, _virtualDomH2['default'])('div', {}, ['\n    ', (0, _virtualDomH2['default'])('ul', {}, ['\n      ', (0, _virtualDomH2['default'])('li', {}, [(0, _virtualDomH2['default'])('a', { onclick: click, href: '/' }, ['Example.com'])]), '\n      ', (0, _virtualDomH2['default'])('li', {}, [(0, _virtualDomH2['default'])('a', { onclick: click, href: '/about' }, ['about'])]), '\n    ']), '\n    ', page, '\n  ']);
...
},{"atom":1,"main-loop":4,"virtual-dom":14,"virtual-dom/h":13}]},{},[45]);
